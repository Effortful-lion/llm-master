---
title: Claude Opus 4.8发布：别被跑分带节奏，真正值得看的是Claude Code工作流
description: Anthropic于2026年5月28日发布Claude Opus 4.8，官方称这是一次modest温和更新。本文从Terminal-Bench脚注、GPT-5.5不同harness分数差异、effort思考强度、Claude Code dynamic workflows、fast mode降价和真实开发选型几个角度，拆解Opus 4.8到底值不值得升级。
keywords: [Claude Opus 4.8, Opus 4.8发布, Claude Code dynamic workflows, Claude Code动态工作流, Anthropic脚注, Terminal-Bench 2.1, GPT-5.5 83.4, fast mode降价, effort思考强度, AI编程, Agent长任务, claude-opus-4-8]
...
我心思这 [4月16日刚发布 4.7](https://mp.weixin.qq.com/s/QJZ34IOWf8vdEiFqugNsMw)，这么快就 4.8了，迭代速度有点快啊！
...
这两天刚写完 [DeepSeek V4-Pro永久降价75%](https://mp.weixin.qq.com/s/GZa2BDnWMsHm5-osXJt3rA)，现在 Opus 4.8 又来了。
