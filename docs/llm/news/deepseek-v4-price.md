---
title: DeepSeek V4降价75%：我接上Claude Code跑了几天，说说真实感受
description: DeepSeek V4-Pro发布不到24小时直接2.5折，输出6元/百万token，V4-Flash输出2元。我接上Claude Code实跑了几天，V4-Flash日常够用性价比无敌，V4-Pro做代码扫描便宜但Agent长任务还是不如Claude。全行业涨价背景下DeepSeek逆行降价的底气在哪？昇腾950和国产算力意味着什么？本文分享真实使用感受。
keywords: [DeepSeek V4降价, DeepSeek V4-Pro特惠, V4-Flash价格, Claude Code接DeepSeek, AI编程模型, 大模型涨价, 昇腾950, 国产算力, DeepSeek使用感受, AI编程性价比, V4-Pro实测]
tags: [DeepSeek, 大模型价格, AI编程, 大模型动态]
---
...
前几天[DeepSeek V4发布](./deepseek-v4.md)那篇，卡哥写的时候还在吐槽："V4-Pro输出24元/百万token，这不像DeepSeek的风格。"
...
这不是V4独有的问题。在[DeepSeek V4发布那篇](./deepseek-v4.md)里我们聊过，Terminal Bench 2.0（测Agent长任务能力）V4-Pro只有67.9，GPT-5.5是82.7。**数字上的差距，到了真实使用里就是"跑着跑着就飞了"。**
...
[Opus 4.7那篇](./claude-opus-4-7.md)结尾我说过，目前我写代码性价比最高的是Claude Agent + CLI + [GLM-5.1](https://www.bigmodel.cn/glm-coding?ic=L9I20DKWAG)。V4降价后，这个思路可以扩展一下：
...
V4-Flash日常用，性价比无敌，这个没什么好犹豫的。V4-Pro特惠期做代码扫描、批量分析，成本几乎忽略，也很香。**但Agent长任务，还是Claude和GPT更稳。** benchmark上的"编码天花板"，到了真实开发场景里，可能只是"编码中等偏上"。这个在[DeepSeek V4发布那篇](./deepseek-v4.md)里我说得很直白了。
