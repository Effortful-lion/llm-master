---
title: DeepSeek V4-Pro永久降价75%：5月22日悄悄改了API定价页，这不是特惠了
description: 2026年5月22日，DeepSeek官方API定价页悄悄更新：V4-Pro在75%折扣活动结束后，将正式调整为原定价的1/4。也就是说，缓存未命中输入从1.74美元降到0.435美元，输出从3.48美元降到0.87美元。本文拆解这次永久降价对开发者、AI编程、Agent任务和大模型价格战的影响。
keywords: [DeepSeek V4-Pro永久降价, DeepSeek API定价, DeepSeek V4价格, V4-Pro 75%降价, V4-Pro输出0.87美元, 大模型价格战, AI编程成本, DeepSeek V4-Pro, DeepSeek V4-Flash, 大模型API成本]
...
前面写[DeepSeek V4降价75%实测](./deepseek-v4-price.md)的时候，卡哥还提醒录友：V4-Pro 的 2.5 折是特惠价，优惠结束后可能会恢复原价。
...
在[DeepSeek V4发布](./deepseek-v4.md)那篇里，我们已经拆过它的能力边界。
