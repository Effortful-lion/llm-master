---
title: Kimi K3发布实测：2.8万亿参数、百万上下文，前端编程与美术审美凭什么冲到第一？
description: 月之暗面正式发布 Kimi K3，模型拥有2.8万亿总参数、100万Token上下文、原生视觉理解，并计划于2026年7月27日前开放完整权重。本文结合Frontend Code Arena公开盲测和首批真实项目实测，重点拆解K3在前端编程、参考图复刻、交互动效、3D场景和产品美术上的能力，同时分析它在长程工程、系统边界、推理速度与开源状态上的限制。
keywords: [Kimi K3, Kimi K3发布, Kimi K3实测, Kimi K3开源, Kimi Code, 月之暗面, Moonshot AI, 2.8万亿参数, 3万亿参数大模型, 100万上下文, 1M上下文, MoE, Kimi Delta Attention, Attention Residuals, 原生多模态, 视觉理解, AI编程, 前端编程, 前端生成, AI写前端, Vibe Coding, 生成式UI, 网页设计, UI设计, 交互动效, Three.js, p5.js, Frontend Code Arena, Arena AI, Claude Fable 5, GPT-5.6 Sol, Claude Opus 4.8, GLM-5.2, 国产大模型, 开源大模型, 大模型评测]
tags: [Kimi, 月之暗面, 大模型发布, AI编程, 前端开发, 多模态, 开源大模型]
---
...
我们在 [Kimi K2.7-Code](./kimi-k2-7-code.md) 里刚聊过“少想废话”，K3 首发阶段反而又回到了“能力优先、先把思考拉满”。
...
在 [GPT-5.6](./gpt-5-6.md) 那篇里我们也说过，Sol 在终端任务和单位成本上很强，但 SWE-Bench Pro 仍然会输给 Claude。
