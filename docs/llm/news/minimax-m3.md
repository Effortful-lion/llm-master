---
title: MiniMax M3评测：SWE-Bench Pro 59.0，1M上下文，原生多模态，真能替代Claude Code吗？
description: MiniMax M3于2026年6月1日发布，主打前沿Coding和Agent能力、1M超长上下文、原生多模态和MiniMax Code。本文从SWE-Bench Pro、Terminal Bench 2.1、MSA稀疏注意力、长上下文成本、论文复现、CUDA算子优化、Token Plan和API价格等角度评测M3，分析它适合哪些AI编程、Agent和多模态场景，以及为什么不能只看官方跑分就迁移生产环境。
keywords: [MiniMax M3, MiniMax-M3, MiniMax M3评测, MiniMax Code, MiniMax Sparse Attention, MSA, 1M上下文, SWE-Bench Pro, Terminal Bench, AI编程, Agent, 多模态大模型, 国产大模型, 开源大模型, Claude Code替代, 大模型评测]
tags: [MiniMax, 大模型发布, AI编程, Agent, 多模态大模型]
---
...
![MiniMax Sparse Attention架构图，展示Index Branch和Sparse Branch如何筛选KV块](https://filecdn.minimax.chat/public/m3-msa-arch.png)

官方给出的说法很激进：

- 在 100 万上下文下，M3 每 Token 计算量只有上代模型的 **1/20**
- Prefilling 阶段超过 **9 倍**加速
- Decoding 阶段超过 **15 倍**加速
...
![MiniMax M3论文复现任务过程图，展示12小时内分阶段推进实验和得分变化](https://filecdn.minimax.chat/public/m3-paper-repro.png)
...
![MiniMax M3 Token Plan套餐图，展示Plus、Max、Ultra三档月度token用量](https://filecdn.minimax.chat/public/m3-token-plan-1.png)
...
![MiniMax M3 API价格图，展示512K以内和512K到1M两档输入输出缓存价格](https://filecdn.minimax.chat/public/20260601-101351-1780280055505.jpeg)
